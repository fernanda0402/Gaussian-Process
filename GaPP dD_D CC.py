...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  3 13:27:52 2023
...
H = z, dD_D, edD_D
#np.savetxt('dD_D_recon_gapp.csv', np.transpose(H), delimiter=', ')
...
# plote
plt.plot(z, dD_D, c='green', label='GP Prediction')
...
#plt.savefig('dD_D_recon_gapp.pdf', format='pdf', bbox_inches='tight')
plt.show()
