...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  5 14:28:53 2023
...
data_dfs8_fs8 = np.genfromtxt('/home/usuario/Documentos/Códigos/GaPP CC/dfs8_fs8_recon_gapp_Matern.csv', delimiter='\t')
...
# baixando os dados
data_Hrec = np.genfromtxt('/home/usuario/Documentos/Códigos/GaPP CC/Hz_recon_gapp_Matern_h0.csv', delimiter=', ')
...
# baixando os dados
data_dHrec = np.genfromtxt('/home/usuario/Documentos/Códigos/GaPP CC/dHz_recon_gapp_Matern_h0.csv', delimiter=', ')
...
#np.savetxt('gamma_recon_fs8_Matern_h0.csv', np.transpose(N), delimiter=', ')
...
plt.plot(z, gamma_rec, color='darkgreen', label='Prediction', linestyle="--")
...
plt.legend(loc='best')
plt.title('GaPP Cosmic Chronometers and $f\sigma_8$ with $H_0$ - Matern Kernel')
#plt.savefig('gamma_fs8_gapp_Matern.pdf', format='pdf', bbox_inches='tight')
plt.show()
