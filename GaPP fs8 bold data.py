...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov  9 11:44:17 2023
...
F = xi, y_pred, sigma
np.savetxt('fs8_recon_bold_gapp.csv', np.transpose(F), delimiter=', ')
...
plt.legend(loc='best')
plt.title('GaPP')
#plt.savefig('fs8_recon_antigo_gapp.pdf', format='pdf', bbox_inches='tight')
plt.show()