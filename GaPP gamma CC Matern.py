...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  5 13:05:45 2023
...
Hz = np.genfromtxt('/home/usuario/Documentos/Códigos/GaPP CC/Hz_recon_gapp_Matern_h0.csv', delimiter=', ')
...
dHz = np.genfromtxt('/home/usuario/Documentos/Códigos/GaPP CC/dHz_recon_gapp_Matern_h0.csv', delimiter=', ')
...
#plt.savefig('dO_O_recon_gapp_Matern.pdf', format='pdf', bbox_inches='tight')
plt.show()
...
np.savetxt('gamma_recon_Matern_h0.csv', np.transpose(N), delimiter=', ')
...
plt.legend(loc='best')
plt.title('GaPP Cosmic Chronometers and $f$ with $H_0$ - Matern Kernel')
#plt.savefig('gamma_CC_Matern.pdf', format='pdf', bbox_inches='tight')
plt.show()
