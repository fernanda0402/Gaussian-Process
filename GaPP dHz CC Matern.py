...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  5 13:01:41 2023
...
g = dgp.DGaussianProcess(x_gapp, y_gapp, e, covfunction=covariance.Matern52, cXstar=(xmin, xmax, nstar))
...
dF = xi, y_pred, sigma
np.savetxt('dHz_recon_gapp_Matern_h0.csv', np.transpose(dF), delimiter=', ')
...
plt.legend(loc='best')
plt.title('GaPP Cosmic Chronometers Kernel Matern')
#plt.savefig('dHz_recon_gapp_Matern.pdf', format='pdf', bbox_inches='tight')
plt.show()
