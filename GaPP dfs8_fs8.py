...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 26 14:53:27 2023
...
fz = np.genfromtxt('/home/usuario/Documentos/Códigos/GaPP CC/fs8_recon_gapp.csv', delimiter=', ')
...
dfz = np.genfromtxt('/home/usuario/Documentos/Códigos/GaPP CC/dfs8_recon_gapp.csv', delimiter=', ')
...
#np.savetxt('dfs8_fs8_recon_gapp.csv', np.transpose(H), delimiter='\t')
...
# PLOTE
plt.plot(z, df_fs8, color='green', label='GP Prediction')
...
plt.legend(loc='best')
#plt.savefig('dfs8_fs8_recon_gapp.pdf', format='pdf', bbox_inches='tight')
plt.show()
