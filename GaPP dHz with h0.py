...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct  9 10:48:28 2023
...
dF = xi, y_pred, sigma
#np.savetxt('dHz_recon_gapp_h0.csv', np.transpose(dF), delimiter=', ')
...
plt.legend(loc='best')
#plt.savefig('dHz_with_h0_recon_gapp.pdf', format='pdf', bbox_inches='tight')
plt.show()
