...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  5 14:16:10 2023
...
F = xi, y_pred, sigma
np.savetxt('fs8_recon_gapp_Matern.csv', np.transpose(F), delimiter=', ')
...
plt.savefig('fs8_recon_gapp_Matern.pdf', format='pdf', bbox_inches='tight')
plt.show()
