...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  5 13:03:57 2023
...
H = z, dh_h, sigma_H
#np.savetxt('dh_h_recon_gapp_Matern.dat', np.transpose(H), delimiter='\t')
...
plt.legend(loc='best')
plt.title('GaPP Cosmic Chronometers with $H_0$ - Matern Kernel')
plt.savefig('dh_h_recon_gapp_Matern.pdf', format='pdf', bbox_inches='tight')
plt.show()
