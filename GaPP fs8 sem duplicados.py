...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov  9 11:09:10 2023
...
data = np.genfromtxt('/home/usuario/Documentos/Dados/fs8_sem_duplicados.dat')
...
F = xi, y_pred, sigma
np.savetxt('fs8_recon_semduplicados_gapp.csv', np.transpose(F), delimiter=', ')
...
plt.legend(loc='best')
plt.title('GaPP')
#plt.savefig('fs8_recon_semduplicados_gapp.pdf', format='pdf', bbox_inches='tight')
plt.show()
