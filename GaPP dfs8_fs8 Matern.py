...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  5 14:24:17 2023
...
fz = np.genfromtxt('/home/usuario/Documentos/Códigos/GaPP CC/fs8_recon_gapp_Matern.csv', delimiter=', ')
...
dfz = np.genfromtxt('/home/usuario/Documentos/Códigos/GaPP CC/dfs8_recon_gapp_Matern.csv', delimiter=', ')
...
np.savetxt('dfs8_fs8_recon_gapp_Matern.csv', np.transpose(H), delimiter='\t')
...
zlcdm = np.linspace(0.001, 2.0, 1000)
...
plt.legend(loc='best')
plt.savefig('dfs8_fs8_recon_gapp_Matern.pdf', format='pdf', bbox_inches='tight')
plt.show()
