...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  3 10:48:49 2023
...
Hz = np.genfromtxt('/home/usuario/Documentos/Códigos/GaPP CC/Hz_recon_gapp.csv', delimiter=', ')
...
dHz = np.genfromtxt('/home/usuario/Documentos/Códigos/GaPP CC/dHz_recon_gapp.csv', delimiter=', ')
...
H = z, dh_h, sigma_H
#np.savetxt('dh_h_recon_gapp.dat', np.transpose(H), delimiter='\t')
...
plt.legend(loc='best')
plt.title('GaPP Cosmic Chronometers - RBF Kernel')
plt.savefig('dh_h_recon_gapp.pdf', format='pdf', bbox_inches='tight')
plt.show()
