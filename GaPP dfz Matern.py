...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  5 12:49:26 2023
...
dF = xi, y_pred, sigma
np.savetxt('dfz_recon_gapp_Matern.csv', np.transpose(dF), delimiter=', ')
...
plt.legend(loc='best')
plt.savefig('dfz_recon_gapp_Matern.pdf', format='pdf', bbox_inches='tight')
plt.show()