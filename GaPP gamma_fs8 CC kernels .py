...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  5 14:32:45 2023
...
data1 = np.genfromtxt('/home/usuario/Documentos/Códigos/GaPP CC/gamma_recon_fs8_h0.csv', delimiter=', ')
...
data2 = np.genfromtxt('/home/usuario/Documentos/Códigos/GaPP CC/gamma_recon_fs8_Matern_h0.csv', delimiter=', ')
...
plt.savefig('gamma_fs8_CC_kernels.pdf', format='pdf', bbox_inches='tight')
plt.show()
