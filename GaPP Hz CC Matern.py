...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  5 12:58:08 2023
...
F = xi, y_pred, sigma
np.savetxt('Hz_recon_gapp_Matern_h0.csv', np.transpose(F), delimiter=', ')
...
#plt.savefig('Hz_recon_gapp_Matern.pdf', format='pdf', bbox_inches='tight')
plt.show()